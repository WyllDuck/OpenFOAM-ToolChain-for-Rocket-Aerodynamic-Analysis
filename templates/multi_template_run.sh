...
./template_run.sh /mnt/e/openfoam-data/WARR_thermal_simulation/configs/config_Ma2.3_AoA8_R0_rhoPimpleFoam.json rhoPimpleFoam ../todo/Ma2.3_AoA8_R0_rhoPimpleFoam
./template_run.sh /mnt/e/openfoam-data/WARR_thermal_simulation/configs/config_Ma2.3_AoA8_R1_rhoPimpleFoam.json rhoPimpleFoam ../todo/Ma2.3_AoA8_R1_rhoPimpleFoam
./template_run.sh /mnt/e/openfoam-data/WARR_thermal_simulation/configs/config_Ma2.3_AoA8_R2_rhoPimpleFoam.json rhoPimpleFoam ../todo/Ma2.3_AoA8_R2_rhoPimpleFoam
./template_run.sh /mnt/e/openfoam-data/WARR_thermal_simulation/configs/config_Ma2.3_AoA8_R3_rhoPimpleFoam.json rhoPimpleFoam ../todo/Ma2.3_AoA8_R3_rhoPimpleFoam
./template_run.sh /mnt/e/openfoam-data/WARR_thermal_simulation/configs/config_Ma2.3_AoA8_R4_rhoPimpleFoam.json rhoPimpleFoam ../todo/Ma2.3_AoA8_R4_rhoPimpleFoam